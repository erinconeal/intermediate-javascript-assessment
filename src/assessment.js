...
function async() {    //   Write a function called async.
  var deferred = $q.defer();//   Use $q to create a promise object and return the promise.
  setTimeout(changeFoo(), 1000)     //   Call setTimeout on a function

  function changeFoo() {
    foo = 'bar';        //   which changes the variable foo (above) to 'bar'
    deferred.resolve();       //   And resolve the promise when setTimeout completes.
  }
